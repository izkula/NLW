function RunJustRegister(vidpath, outdir, templatepath, imagejPath, imagejMacroPath)
...
cmd = [imagejPath, ' -macro ', imagejMacroPath, '/turboreg_noDenoiseNLW.ijm ''',vidpath,' ', outdir, ' ', templatepath '''']
% cmd = ['xvfb-run -a ', imagejPath, ' -macro ', imagejMacroPath, '/turboreg_noDenoiseNLW.ijm ''',vidpath,' ', outdir, ' ', templatepath '''']; %%% Uncomment this instead for headless mode
