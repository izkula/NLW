...
% cmd = [imagejPath, ' -macro ', imagejMacroPath, '/turboreg_noDenoise.ijm ''',vidpath,' ', outdir, ' ', templatepath '''']
cmd = ['xvfb-run -a ', imagejPath, ' -macro ', imagejMacroPath, '/turboreg_noDenoise.ijm ''',vidpath,' ', outdir, ' ', templatepath ''''];
