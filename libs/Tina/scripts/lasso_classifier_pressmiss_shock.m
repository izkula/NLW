function [cells_lasso,weights_lasso]=lasso_classifier_pressmiss_shock(pathname,filedate,filename)

load(strcat(pathname,filedate,'/results/',filename,'.mat'));
load(strcat(pathname,filedate,'/regression/',filename,'_shockonly.mat'));
...
dfof_trials_pressed_tone=dfof_trials_pressed_tone(shock_only,:,:);
dfof_trials_missed_tone=dfof_trials_missed_tone(shock_only,:,:);
...
cells_lasso=shock_only(cells_lasso);

savename=strcat(pathname,filedate,'/results/',filename,'_lasso_pressmiss_shock.mat');
