...
for z=1:length(dates)
    ...
    load(strcat(pathname,date,'/regression/',filename,'_peaks_reward.mat'));
...
dates={'20160529','20160730','20160730'};
filenames={'GRIN_pfcvta15_tonerewardshock_day5','GRIN_pfcvta1_tonerewardshock_day4','GRIN_pfcvta2_tonerewardshock_day5'};
